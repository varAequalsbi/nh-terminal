...
export default function Dashboard() {
  ...
  const [priceData, setPriceData] = useState({
    ...
    timestamp: '11:38 WIB',
    history: [
      { name: '1', value: 3405.50 },
      { name: '2', value: 3412.30 },
      { name: '3', value: 3408.20 },
      { name: '4', value: 3415.80 },
      { name: '5', value: 3410.40 },
      { name: '6', value: 3418.70 },
      { name: '7', value: 3412.50 },
      { name: '8', value: 3420.10 },
      { name: '9', value: 3416.30 },
      { name: '10', value: 3422.80 },
      { name: '11', value: 3419.50 },
      { name: '12', value: 3425.20 },
      { name: '13', value: 3421.40 },
      { name: '14', value: 3427.20 },
      { name: '15', value: 3424.80 },
      { name: '16', value: 3429.30 },
      { name: '17', value: 3426.50 },
      { name: '18', value: 3430.70 },
    ],
  });
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setPriceData(prev => {
        ...
        const lastIndex = prev.history.length;
        const newHistory = [...prev.history.slice(1), { name: String(lastIndex + 1), value: newPrice }];
